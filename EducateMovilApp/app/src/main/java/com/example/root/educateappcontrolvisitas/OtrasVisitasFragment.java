 ...
 */
public class OtrasVisitasFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView = inflater.inflate(R.layout.otras_visitas_lista, container, false);
        ...
        ListView listView = (ListView) rootView.findViewById(R.id.otrasVisitasList);
